...
set CYGWIN_PACKAGES=bash-completion,bc,curl,expect,git,git-svn,gnupg,inetutils,lz4,mc,nc,openssh,openssl,perl,python,pv,ssh-pageant,subversion,unzip,vim,wget,zip,zstd,python3,python-pip,python3-pip,graphviz,unison2.51,make,gcc-g++,ncdu,gdb,tree
