...
set CYGWIN_PACKAGES=bash-completion,bc,curl,expect,git,gnupg,inetutils,mc,nc,openssh,openssl,perl,python3,pv,unzip,vim,wget,zip,zstd,graphviz,unison2.51,make,gcc-g++
